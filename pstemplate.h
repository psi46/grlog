...
"  yield  5 get (CL4: DCol def)       0 -110 -140 legendEntry\n"
"  yield  6 get (CL4: >40 pix def)   16 -110 -146 legendEntry\n"
"  yield  7 get (CL4: mask def)      10 -110 -152 legendEntry\n"
"  \n"
"  yield  8 get (CL4: address def)   12 -40 -110 legendEntry\n"
"  yield  9 get (CL4: IdigOn >65mA)  14 -40 -116 legendEntry\n"
"  yield 10 get (CL4: IanaOn >10mA)  15 -40 -122 legendEntry\n"
"  yield 11 get (CL4: IdigInit)      17 -40 -128 legendEntry\n"
"  yield 12 get (CL4: IanaInit)       3 -40 -134 legendEntry\n"
"  yield 13 get (CL3: >4 pix def)    26 -40 -140 legendEntry\n"
"  yield 14 get (CL3: Thr mean)      23 -40 -146 legendEntry\n"
"  yield 15 get (CL3: Thr stdev)     24 -40 -152 legendEntry\n"
"  \n"
"  yield 16 get (CL3: Thr col diff)  25  45 -110 legendEntry\n"
"  yield 17 get (CL3: Ph Offset)     31  45 -116 legendEntry\n"
"  yield 18 get (CL3: Ph Gain)       20  45 -122 legendEntry\n"
"  yield 19 get (CL3: Ph col diff)   22  45 -128 legendEntry\n"
"  yield 20 get (CL3: ID tolerance)   1  45 -134 legendEntry\n"
"  yield 21 get (CL3: IA tolerance)   2  45 -140 legendEntry\n"
"  yield 22 get (CL2: 1..4 pix def)  18  45 -146 legendEntry\n"
"  yield 23 get (CL1: good)          28  45 -152 legendEntry\n"
"}def\n"
"\n"
"/legend_class\n"
"{\n"
...
"  -5.16 -4.00 translate\n"
"  newpath\n"
"  0 1 10 { 0 moveto 0 8.93 rlineto }for\n"
"  0 1  8 { -1.3 exch moveto 12.3 0 rlineto }for\n"
...
"\n"
"  0.25 fontSize\n"
"  0.33 8.7 moveto (Y0) show\n"
"  1.33 8.7 moveto (Y1) show\n"
"  2.33 8.7 moveto (Y2) show\n"
"  3.33 8.7 moveto (Y3) show\n"
"  4.33 8.7 moveto (Y4) show\n"
"  5.33 8.7 moveto (Y5) show\n"
"  6.33 8.7 moveto (Y6) show\n"
"  7.33 8.7 moveto (Y7) show\n"
"  8.33 8.7 moveto (Y8) show\n"
"  9.33 8.7 moveto (Y9) show\n"
"  10.33 8.7 moveto (YA) show"
"  -1.2 7.42 moveto (0X) show\n"
"  -1.2 6.42 moveto (1X) show\n"
"  -1.2 5.42 moveto (2X) show\n"
"  -1.2 4.42 moveto (3X) show\n"
"  -1.2 3.42 moveto (4X) show\n"
"  -1.2 2.42 moveto (5X) show\n"
"  -1.2 1.42 moveto (6X) show\n"
"  -1.2 0.42 moveto (7X) show\n"
"  grestore\n"
"}bind def\n"
"\n"
"/waferOutline\n"
...
"/chipPos\n"
"{ % ABCD\n"
"  [0.05 0.1  8.1 0.1  0.05 10.7  8.1 10.7]\n"
